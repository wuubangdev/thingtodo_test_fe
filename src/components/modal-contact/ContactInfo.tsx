        ...
        <div className='border-b-[1px] border-bg-fc/10 pb-6 flex flex-col gap-6'>
            ...
            >
                ...
                <div className={`relative duration-300 ${isHover ? "h-12 pt-2 pb-3 px-2 opacity-100" : "opacity-0 h-0 "}`}>
                    ...
                    >
                        <span className={`${isHover ? "text-black -translate-x-2 font-semibold" : "text-white translate-x-1"}  delayed-hover duration-300`}>{button}</span>
                        <svg
                            className={`${isHover ? "opacity-100" : 'opacity-0'}  delayed-hover`}
