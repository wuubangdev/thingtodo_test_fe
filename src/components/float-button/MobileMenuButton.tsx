                    ...
                    <div className='flex items-top justify-end gap-4'>
                        <div
                            className={`group rounded-3xl 
                                ${isOpen ?
                                    "translate-x-0 opacity-100  border-2 duration-500"
                                    :
                                    "  translate-x-96 opacity-0"} flex justify-center 
                                    ${isHover ? 'pl-6 pr-4 bg-white duration-300 delayed-hover' : 'px-4 bg-transparent'}
                                     items-center duration-300 border-[1px] border-white py-1 px-4 cursor-pointer body-2-medium`}
                            onClick={() => setIsContactOpen(true)}
                        >
                            <span className={`
                                ${isHover
                                    ?
                                    "-translate-x-[6px] delayed-hover text-primary"
                                    :
                            ...
                            <svg
                                ...
                                strokeWidth="1.5"
                                stroke="currentColor"
                                className={`size-5 ${isHover ? 'scale-x-100 delayed-hover text-primary' : ' text-white scale-x-0'} right duration-500 rotate-180`}
                            >
