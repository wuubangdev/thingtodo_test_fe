        ...
        <>
            {!isVisibleContact &&
                ...
                >
                        ...
                        <div className='flex justify-between items-center'>
                            ...
                            <div>
                                <div
                                    ...
                                    onClick={() => setIsVisibleContact(true)}
                                >
                    ...
                    {/* Mobile */}
                    <div className={`grid md:hidden  ${isVisible ? 'grid-cols-1' : 'grid-cols-2 p-4'}  ${isPrimary ? 'text-white bg-primary' : 'text-black bg-white'}`}>
                        {!isVisible &&
                            <>
                                <div className='flex items-center gap-6'>
