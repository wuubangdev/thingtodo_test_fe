        ...
        <>
            ...
            <div className='bg-primary text-white flex md:hidden flex-col gap-28 px-4 pb-6'>
                ...
                <div className='border-b-[0.5px] pt-12 pb-6  border-white flex items-end gap-6'>
                    <h4 className='text-custom-phone leading-[54px]'>LET'S COLLAB</h4>
                    <div>
                        <Image
                            alt=''
                            src={'/logo/arrow.png'}
                ...
                <div className='flex md:hidden flex-col gap-28'>
                    <div className='grid grid-cols-1 gap-20'>
                        <div className='text-2xl'>Visit us on <br /> Behance</div>
                        <div className='w-full col-span-1'>
                            <Image
                                alt='footer-logo'
                        ...
                        <div className='flex flex-col gap-2'>
                            <div className='text-2xl leading-6'>Connect us</div>
                            <div className='text-[2.75rem] leading-[2.75rem]'>+84 966 080 411</div>
                        </div>
                        <div className='text-sm'>
                            © 2024 Thingtodo Agency
                        </div>
